# Contrato do módulo — audit

Este documento resume o contrato local de audit. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
